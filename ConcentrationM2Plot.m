...
Out0001_temp = load(files(1).name');
Out0001_temp = Out0001_temp.output;


% Ignore the first 4 points

for cc = 4:length([Out0001_temp.xc])-1
Out0001(cc-3).SigmaXX = Out0001_temp(cc).SigmaXX*conv_f^2;
Out0001(cc-3).SigmaXY = Out0001_temp(cc).SigmaXY*conv_f;
Out0001(cc-3).SigmaYY = Out0001_temp(cc).SigmaYY;
Out0001(cc-3).xc = Out0001_temp(cc).xc*conv_f;
Out0001(cc-3).yc = Out0001_temp(cc).yc;
Out0001(cc-3).iteration = Out0001_temp(cc).iteration;
Out0001(cc-3).M2XX = Out0001_temp(cc).M2XX;
Out0001(cc-3).M2XY = Out0001_temp(cc).M2XY;
Out0001(cc-3).M2YY = Out0001_temp(cc).M2YY;

end

Out001_temp = load(files(2).name');
Out001_temp = Out001_temp.output;

for cc = 4:length([Out001_temp.xc])-1
Out001(cc-3).SigmaXX = Out001_temp(cc).SigmaXX*conv_f^2;
Out001(cc-3).SigmaXY = Out001_temp(cc).SigmaXY*conv_f;
Out001(cc-3).SigmaYY = Out001_temp(cc).SigmaYY;
Out001(cc-3).xc = Out001_temp(cc).xc*conv_f;
Out001(cc-3).yc = Out001_temp(cc).yc;
Out001(cc-3).iteration = Out001_temp(cc).iteration;
Out001(cc-3).M2XX = Out001_temp(cc).M2XX;
Out001(cc-3).M2XY = Out001_temp(cc).M2XY;
Out001(cc-3).M2YY = Out001_temp(cc).M2YY;

end


Out01_temp = load(files(3).name');
Out01_temp = Out01_temp.output;

for cc = 4:length([Out01_temp.xc])-1
Out01(cc-3).SigmaXX = Out01_temp(cc).SigmaXX*conv_f^2;
Out01(cc-3).SigmaXY = Out01_temp(cc).SigmaXY*conv_f;
Out01(cc-3).SigmaYY = Out01_temp(cc).SigmaYY;
Out01(cc-3).xc = Out01_temp(cc).xc*conv_f;
Out01(cc-3).yc = Out01_temp(cc).yc;
Out01(cc-3).iteration = Out01_temp(cc).iteration;
Out01(cc-3).M2XX = Out01_temp(cc).M2XX;
Out01(cc-3).M2XY = Out01_temp(cc).M2XY;
Out01(cc-3).M2YY = Out01_temp(cc).M2YY;

end

Out4_temp = load(files(4).name');
Out4_temp = Out4_temp.output;

for cc = 4:length([Out4_temp.xc])-1
Out4(cc-3).SigmaXX = Out4_temp(cc).SigmaXX*conv_f^2;
Out4(cc-3).SigmaXY = Out4_temp(cc).SigmaXY*conv_f;
Out4(cc-3).SigmaYY = Out4_temp(cc).SigmaYY;
Out4(cc-3).xc = Out4_temp(cc).xc*conv_f;
Out4(cc-3).yc = Out4_temp(cc).yc;
Out4(cc-3).iteration = Out4_temp(cc).iteration;
Out4(cc-3).M2XX = Out4_temp(cc).M2XX;
Out4(cc-3).M2XY = Out4_temp(cc).M2XY;
Out4(cc-3).M2YY = Out4_temp(cc).M2YY;
end
...
semilogx([Out0001.iteration]*t_d(1),[Out0001.yc],cell2mat(shapewline(1)),'color' ,col(1,:)) 
hold on
semilogx([Out001.iteration]*t_d(2),[Out001.yc],cell2mat(shapewline(2)),'color' ,col(2,:))
hold on
semilogx([Out01.iteration]*t_d(3),[Out01.yc],cell2mat(shapewline(3)),'color' ,col(3,:)) 
hold on
semilogx([Out4.iteration]*t_d(4),[Out4.yc],cell2mat(shapewline(4)),'color' ,col(4,:)) 
hold on
...
semilogx([Out0001.iteration]*t_d(1),[Out0001.SigmaYY],cell2mat(shapewline(1)),'color' ,col(1,:)) 
hold on
semilogx([Out001.iteration]*t_d(2),[Out001.SigmaYY],cell2mat(shapewline(2)),'color' ,col(2,:))
hold on
semilogx([Out01.iteration]*t_d(3),[Out01.SigmaYY],cell2mat(shapewline(3)),'color' ,col(3,:)) 
hold on
semilogx([Out4.iteration]*t_d(4),[Out4.SigmaYY],cell2mat(shapewline(4)),'color' ,col(4,:)) 
hold on
grid on
...
semilogx(([Out0001(2:end).iteration]*t_d(1)),diff([Out0001.SigmaYY])/dt(1),cell2mat(shapewline(1)),'color' ,col(1,:)) 
hold on
semilogx(([Out001(2:end).iteration]*t_d(2)),diff([Out001.SigmaYY])/dt(2),cell2mat(shapewline(2)),'color' ,col(2,:))
hold on
semilogx(([Out01(2:end).iteration]*t_d(3)),diff([Out01.SigmaYY])/dt(3),cell2mat(shapewline(3)),'color' ,col(3,:)) 
hold on
semilogx(([Out4(2:end).iteration]*t_d(4)),diff([Out4.SigmaYY])/dt(4),cell2mat(shapewline(4)),'color' ,col(4,:)) 
hold on
symlog(gca,'y',-9)
...
xlabel('$t_{d}$')
ylabel('$d \sigma^{2}_{d(yy)} \big/ dt_{d}$')
...
% ylim([2 10])
pbaspect([2 1 1]);  
set(gca,'Position', [0.1300 0.1337 0.7750 0.7913],'OuterPosition', [0 0.0263 1 0.9715]); F = getframe(fig);
